...
import static com.coderbunker.mylibrary.Apps.Params.VOICE_TRANSCRIPTION_MESSAGE_PATH;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.send_msg)
            ...
            public void onClick(View v) {
                Log.d(App.TAG, "Send msg");
                requestTranscription("Hello brave new world!".getBytes());
            }
        });
    }
