...
import com.coderbunker.android.sunshine.library.Params;
...
import com.coderbunker.android.sunshine.model.Model;
...
public class WeatherListPresenter {
    ...
    public WeatherListPresenter(GoogleApiClient googleApiClient, WeatherListView view) {
        ...
        this.channelApi = googleApiClient.getContext().getString(com.coderbunker.android.sunshine.library.R.string.resource_weather_update);
    }
                ...
                .setResultCallback(
                        new ResultCallback() {
                            ...
                            public void onResult(@NonNull Result result) {
                                Log.d(com.coderbunker.android.sunshine.library.App.TAG, "Send message: "
