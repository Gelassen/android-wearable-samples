...
import com.coderbunker.android.sunshine.library.WearableActivity;
...
//                createListener();
            ...
            public void onClick(View v) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.d(com.coderbunker.android.sunshine.library.App.TAG, "[find] Nodes: " + nodes.size());
                    }
                }).start();
            }
    ...
    public void onMessageReceived(MessageEvent messageEvent) {
        Log.d(com.coderbunker.android.sunshine.library.App.TAG, "onMessageReceived");
    }
    ...
    public void findNodes() {
        Log.d(com.coderbunker.android.sunshine.library.App.TAG, "findNodes");
        CapabilityApi.GetCapabilityResult result =
                Wearable.CapabilityApi.getCapability(
