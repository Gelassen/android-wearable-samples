 ...
 */
package com.coderbunker.android.sunshine.utilities;
...
public final class SunshineWeatherUtils {
    ...
    public static int getSmallArtResourceIdForWeatherCondition(int weatherId) {
        return com.coderbunker.android.sunshine.library.utils.SunshineWeatherUtils.getSmallArtResourceIdForWeatherCondition(weatherId);
    }
