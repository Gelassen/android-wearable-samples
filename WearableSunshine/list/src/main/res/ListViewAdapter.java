...
package com.coderbunker.demoview;
...
public class ListViewAdapter extends WearableListView.Adapter  {
    ...
    public WearableListView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new WearableListView.ViewHolder(new com.coderbunker.demoview.ListViewRowView(context));
    }

    @Override
    public void onBindViewHolder(WearableListView.ViewHolder viewHolder, int i) {
        com.coderbunker.demoview.ListViewRowView listViewRowView = (com.coderbunker.demoview.ListViewRowView) viewHolder.itemView;
